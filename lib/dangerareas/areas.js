...
var retrieveGeometries = function(callback) {
  ...
  request('http://'+config.geoserverHostPort+'/geoserver/dwa-hackathon/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=dwa-hackathon:senken_signifikant&maxFeatures=1000&outputFormat=application%2Fjson').then(function(data) {
